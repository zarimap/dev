...
[日本語]
本リポジトリ内のコンテンツ（コード、データ、ドキュメント等を含む）の著作権は、すべて Zarimap project に帰属します。

利用者は、本リポジトリ内のコンテンツをデータとして参照・利用することができます。ただし、以下の行為を厳しく禁止します。

1. 本コンテンツの全部または一部を、無断で複製（コピー）すること。
2. 本コンテンツを改変、修正、または二次的著作物を作成すること。
3. 著作権表示（Copyright）を削除または変更すること。

転載、引用、またはデータの利用にあたっては、必ず以下の著作権表示を明記してください。
